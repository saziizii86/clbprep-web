...
const resetTest = () => {
  ...
  // ============== RENDER FUNCTIONS ==============
const PANEL_CLASS =
  "bg-white/90 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-slate-200 w-full max-w-[980px] mx-auto min-h-[620px] flex flex-col";
    ...
    return (
	  <div className={PANEL_CLASS}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Side */}
<div className="bg-gradient-to-br from-slate-50 to-blue-50/50 rounded-2xl p-5 border border-slate-200/80 flex flex-col min-h-[460px] overflow-hidden">
  ...
  const renderResults = () => {
    ...
    return (
      <div className={PANEL_CLASS}>
        ...
        <div className="mt-auto pt-6 flex gap-4 flex-wrap">
          <button
            onClick={resetTest}
            className="flex-1 py-4 bg-slate-100 text-slate-700 rounded-2xl font-semibold hover:bg-slate-200 transition-all flex items-center justify-center gap-2"
          >
