// src/pages/Mock/S_T2_MockTest.tsx  –  Speaking Task 2: Personal Experience
...
const TASK = 2, TASK_ID = "part2", PREP_TIME = 30;
const TASK_LABEL = "Speaking Task 2: Personal Experience";
const NEXT_ROUTE = "/speaking/3";

export default function S_T2_MockTest({ material: pre, mockSet: preSet, onComplete, onBack }: {
