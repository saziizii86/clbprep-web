// src/pages/Mock/S_T3_MockTest.tsx  –  Speaking Task 3: Describing a Scene
...
const TASK = 3, TASK_ID = "part3", PREP_TIME = 30;
const TASK_LABEL = "Speaking Task 3: Describing a Scene";
const NEXT_ROUTE = "/speaking/4";

export default function S_T3_MockTest({ material: pre, mockSet: preSet, onComplete, onBack }: {
