// src/pages/Mock/S_T4_MockTest.tsx  –  Speaking Task 4: Making Predictions
...
const TASK = 4, TASK_ID = "part4", PREP_TIME = 30;
const TASK_LABEL = "Speaking Task 4: Making Predictions";
const NEXT_ROUTE = "/speaking/5";

export default function S_T4_MockTest({ material: pre, mockSet: preSet, onComplete, onBack }: {
...
const apply = useCallback(async (doc: any) => {
  ...
  {/* NEW CODE: Added md:pt-10 to move it DOWN */}
<div className={hasImages ? "grid grid-cols-1 md:grid-cols-3 gap-6 items-start md:px-17 md:pt-10" : ""}>
    {phase === "prep" ? (
