// src/pages/Mock/S_T6_MockTest.tsx  –  Speaking Task 6: Difficult Situation
...
const TASK = 6, TASK_ID = "part6", PREP_TIME = 60;
const TASK_LABEL = "Speaking Task 6: Difficult Situation";
const NEXT_ROUTE = "/speaking/7";

export default function S_T6_MockTest({ material: pre, mockSet: preSet, onComplete, onBack }: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 p-6">
      <PracticeFrame
        ...
        rightStatus={<span className="text-xs text-white/80">Preparation: <b>60s</b> &nbsp; Recording: <b>{maxRec}s</b></span>}
        onNext={handleNext}
        onBack={handleBack}
