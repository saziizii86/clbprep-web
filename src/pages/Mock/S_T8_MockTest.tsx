// src/pages/Mock/S_T8_MockTest.tsx  –  Speaking Task 8: Unusual Situation
...
const TASK = 8, TASK_ID = "part8", PREP_TIME = 30;
const TASK_LABEL = "Speaking Task 8: Unusual Situation";
const NEXT_ROUTE = "/speaking/results";

export default function S_T8_MockTest({ material: pre, mockSet: preSet, onComplete, onBack }: {
...
const apply = useCallback(async (doc: any) => {
    ...
    const maxRec = parseInt(u?.recordingTime) || 60;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 p-6">
      <PracticeFrame
        ...
        onNext={handleNext}
        onBack={handleBack}
        nextLabel={phase === "transcribing" ? "Saving..." : "FINISH"}
      >
        <div className="p-6 space-y-6">
          ...
          {/* ✅ Match Task 4: Image LEFT + Compact Timecard RIGHT */}
<div className={hasImages ? "grid grid-cols-1 md:grid-cols-3 gap-6 items-start md:px-6" : ""}>

  {/* LEFT: Image(s) */}
  {hasImages && (
    <div className="md:col-span-2 flex justify-center md:justify-start md:ml-12">
  ...
  {/* RIGHT: Compact timecard (same position style as Task 4) */}
  <div className={`${hasImages ? "md:col-span-1 flex justify-center md:pt-10 md:pr-6" : "flex justify-center"}`}>
    {phase === "prep" ? (
