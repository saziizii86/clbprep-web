...
const GAMES = [
  { id: "word-search",      title: "Word Search",        description: "Find hidden English words in a letter grid. Great for vocabulary and spelling.", icon: <Search className="w-7 h-7" />, color: "text-blue-600",   bgColor: "bg-blue-50",   borderColor: "border-blue-400",   badge: "Vocabulary", skills: ["Vocabulary","Spelling"] },
  { id: "matching",         title: "Matching Game",       description: "Match words to their meanings. Flip cards to find the right pairs!", icon: <Layers className="w-7 h-7" />, color: "text-purple-600", bgColor: "bg-purple-50", borderColor: "border-purple-400", badge: "Memory",     skills: ["Vocabulary","Memory"] },
  { id: "sentence-builder", title: "Sentence Builder",    description: "Arrange jumbled words into the correct sentence. Master grammar and word order.", icon: <AlignLeft className="w-7 h-7" />, color: "text-green-600",  bgColor: "bg-green-50",  borderColor: "border-green-400",  badge: "Grammar",    skills: ["Grammar","Word Order"] },
  { id: "fill-blank",       title: "Fill in the Blank",   description: "Complete sentences with the missing word. Perfect for grammar and verb tenses.", icon: <PenLine className="w-7 h-7" />, color: "text-orange-600", bgColor: "bg-orange-50", borderColor: "border-orange-400", badge: "Grammar",    skills: ["Grammar","Tenses"] },
  { id: "listening-puzzle", title: "Listening Puzzle",    description: "Listen to natural AI speech and arrange the words you heard. Sharpen your ear!", icon: <Headphones className="w-7 h-7" />, color: "text-teal-600",   bgColor: "bg-teal-50",   borderColor: "border-teal-400",   badge: "Listening",  skills: ["Listening","Comprehension"] },
  { id: "dialogue",         title: "Dialogue Completion", description: "Complete real-life conversations with the best response. Daily English practice.", icon: <MessageSquare className="w-7 h-7" />, color: "text-rose-600",   bgColor: "bg-rose-50",   borderColor: "border-rose-400",   badge: "Speaking",   skills: ["Communication","Real-life English"] },
];
